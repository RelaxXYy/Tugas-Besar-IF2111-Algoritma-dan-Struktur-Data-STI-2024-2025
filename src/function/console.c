...
void execute_command() {
    ...
    if (is_same_string(command, "HELP") == true) {
        ...
        ignore_first_word(command, no_first_word);
        get_first_word(no_first_word, first_word);
        ...
        else if (is_same_string(first_word, "REMOVE") == true && is_user_logged_in == true && is_session_started == true){
        ...
        else if (is_same_string(first_word, "SWAP") == true && is_user_logged_in == true && is_session_started == true){
    ...
    } else if (is_same_string(first_word, "HISTORY" ) == true && is_user_logged_in == true && is_session_started == true) {
        ignore_first_word(input, no_first_word);
